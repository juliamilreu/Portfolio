...
.reel-holder, .reel-holder iframe { position: absolute; inset: 0; width: 100%; height: 100%; border: 0; }
...
.filters button:hover { background: rgba(238,86,90,0.08); }
.filters button.active { background: var(--primary); color: var(--white); }
/* Grid de projetos */
...
.project .back { display: inline-flex; align-items: center; gap: 8px; color: var(--primary); font-weight: 700; text-transform: uppercase; font-size: 15px; letter-spacing: .04em; margin-bottom: 26px; }
...
.cp-cover { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; display: block; }
.cp-play {
  position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);
...
.cp-holder, .cp-holder iframe { position: absolute; inset: 0; width: 100%; height: 100%; border: 0; }
...
.b-gallery { display: grid; grid-template-columns: repeat(var(--cols), 1fr); gap: 40px; justify-content: center; justify-items: center; margin: 0 auto; max-width: 70%; }
.b-gallery .g-item { width: 100%; min-width: 0; }
.b-gallery .ratio { border-radius: 15px; aspect-ratio: 1 / 1; }
.gallery-video .gv-cover { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; display: block; z-index: 2; transition: opacity .4s ease; }
.gallery-video.ready .gv-cover { opacity: 0; }
.gv-holder, .gv-holder iframe { position: absolute; inset: 0; width: 100%; height: 100%; border: 0; z-index: 1; }
.gallery-file video { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; display: block; }
.gallery-image img { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; display: block; }
.g-title { font-family: "Encode Sans Condensed", sans-serif; font-weight: 700; font-size: 22px; text-align: center; color: var(--dark); margin-bottom: 14px; }
...
@media (max-width: 820px) {
  ...
  .brand-logo-lottie { height: 60px; width: 276px; }
